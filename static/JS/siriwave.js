function SiriWave(opt) {
    ...
    this.frequency = opt.frequency || 7;
...
SiriWave.prototype._ypos = function(i, attenuation, flag) {
    ...
    return this.height_2 + this._globAttFunc(i) * att * Math.sin(frequency * i - this.phase) + x;

};

SiriWave.prototype._drawLine = function(attenuation, color, width, flag) {
    this.ctx.moveTo(0, 0);
    this.ctx.beginPath();
